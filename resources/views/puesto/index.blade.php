...
<div class="card-body shadow" >
              <div class="card-header bg-transparent border-0" style="background-color: #fff;"> 
                <div class="col text-right">
                    ...
                    <a href="{{ url('puesto/create') }}" class="btn btn-primary" style="background-color:#008a8a; color:#fff"> 
                       Registrar Puesto
                    </a>                          
                  </div>
              </div>
                  ...
                  <tbody class="list">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <a class='editar btn btn-warning' href="{{ url('/puesto/'.$puesto->id.'/edit') }}" title="Editar Datos">
                            <i class="fa fa-edit"></i>
                        </a>
                        @endif

                        @if (@auth()->user()->perfil == "Administrador")
                        <form action="{{ url('/puesto/'.$puesto->id) }}" class="d-inline form-delete" method='POST'>
                            {{ method_field('DELETE') }}   
                            @csrf
                                <button type="submit" 
