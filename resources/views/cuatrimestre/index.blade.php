...
<div class="card-header bg-transparent border-0" style="background-color: #fff;"> 
                <div class="col text-center">
                    <h2 class="card-title">Cuatrimestres</h2>                
                </div>
            </div>
             <div class="card-body shadow" >
              <div class="card-header bg-transparent border-0" style="background-color: #fff;"> 
                <div class="col text-right">
                    ...
                    <a  href="{{ url('cuatrimestre/create') }}" class="btn btn-primary" style="background-color:#008a8a; color:#fff"> 
              ...
              <div class="table-responsive"  style="overflow: hidden; ">
               <table id="tbasignados" class="table table-bordered table-hover dt-responsive nowrap display" style="width:100%">
                    ...
                    <tr>
                        <th scope="col" class="sort"  style="color:#fff" data-sort="budget">Periodo</th>
                        <th scope="col" class="sort"  style="color:#fff" data-sort="budget">Inicio</th>
                        <th scope="col" class="sort" style="color:#fff;" data-sort="budget">Término</th>
                        <th scope="col" class="sort" style="color:#fff;" data-sort="budget">Año</th>
                  ...
                  <tbody class="list">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <a class='editar btn btn-warning' href="{{ url('/cuatrimestre/'.$cuatrimestre->id.'/edit') }}"  title="Editar Datos">
                            <i class="fa fa-edit"></i>
                        </a>
                        @endif

                        @if (@auth()->user()->perfil == "Administrador")
                        <form action="{{ url('/cuatrimestre/'.$cuatrimestre->id) }}" class="d-inline form-delete" method='POST'>
                            {{ method_field('DELETE') }}   
                            @csrf
                                <button type="submit" 
...
@endif
   ...
   $('.form-delete').submit(
        ...
        Swal.fire({
                title: '¿Desea eliminar este cuatrimestre?',
